...
class VistaPrestamosFinalizadosModal extends Component
{
    ...
    public string $tipoLista = 'prestamos_finalizados'; // Identificador para la ruta

    protected $listeners = ['abrirVistaPrestamosFinalizadosModal' => 'abrirModal'];
    ...
    {
        return view('livewire.vista-liquidacion.vista-prestamos-finalizados-modal');
    }
}