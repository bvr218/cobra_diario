...
class VistaRefinanciacionesModal extends Component
{
    ...
    public string $tipoLista = 'refinanciaciones'; // Identificador para la ruta

    protected $listeners = ['abrirVistaRefinanciacionesModal' => 'abrirModal'];
    ...
    {
        return view('livewire.vista-liquidacion.vista-refinanciaciones-modal');
    }
}