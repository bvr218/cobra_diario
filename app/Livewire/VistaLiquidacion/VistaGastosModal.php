...
class VistaGastosModal extends Component
{
    ...
    public string $tipoLista = 'gastos'; // Identificador para la ruta

    protected $listeners = ['abrirVistaGastosModal' => 'abrirModal'];
    ...
    {
        return view('livewire.vista-liquidacion.vista-gastos-modal');
    }
}