<div> {{-- REQUERIDO: Elemento raíz único que siempre se renderiza --}}

    @if($showModal) {{-- La lógica condicional ahora está DENTRO del elemento raíz --}}
        <div class="modal-backdrop">
            <div class="modal-content" @click.away="cerrarModal" x-data="{ print() { window.print(); } }">
                <div class="modal-header no-print">
                    <h3 class="modal-title">{{ $titulo }}</h3>
                    <button wire:click="cerrarModal" class="modal-close-button">×</button>
                </div>
                <div id="printable-comisiones-content" class="printable-area">
                    ...
                    <div class="modal-table-container">
                        <table class="modal-table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr><td colspan="4" class="modal-empty-message">No se encontraron comisiones.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
        ...
        @once
        <style>
            /* Puedes mantener tus estilos aquí si son específicos de este modal */
